export class RemoteModuleExample {
  constructor(options, parent) {  
    this.parent = parent
    this.type = "RemoteModuleExample" // use this to call organizm.modules.Example.test_function("test")
...
export let  remoteModuleExampleOptions = {
