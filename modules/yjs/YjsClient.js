...
export class YjsClient {
  constructor(options, parent) {  
    this.parent = parent
    this.type = "YjsClient" // use this to call organizm.modules.Example.test_function("test")
    ...
    this.room = options.default_room
...
export let  yjsClientOptions = {
  // "name": "Name of the YjsClient Module",
  // "params": {
  //   "un": "1",
  //   "deux": "2",
  //   "trois": "3"
  ...
  // },
  "providers":[
    {"name": "local_ws", "url": "ws://0.0.0.0:1234"},

  ],
  "default_room": "my-roomname",
  "autoinit": true
}