...
import { 
  ...
  import { displayThings, displayPaths } from "./utils/display.js";
...
//       this.readFileFromPod('http://localhost:3000/david/truc/file.json', this.session.fetch, 'file.json')
//     }
//       // Read file from Pod and save to local file
// async  readFileFromPod(fileURL, fetch, saveAsFilename) {
//   try {
